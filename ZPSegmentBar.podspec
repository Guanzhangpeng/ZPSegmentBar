...
Pod::Spec.new do |s|
  s.name             = 'ZPSegmentBar'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ZPSegmentBar.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/gzp/ZPSegmentBar'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'gzp' => 'zswangzp@163.com' }
  s.source           = { :git => 'https://github.com/gzp/ZPSegmentBar.git', :tag => s.version.to_s }
